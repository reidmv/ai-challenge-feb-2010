...
# Grabbed from http://sed.sourceforge.net/grabbag/scripts/remccoms3.sed
# on Thursday, Feb. 11 2010 by Reid Vandewiele <marut>
...
# Added to cut leading tabs/spaces and empty lines
s/^[ \t]*//
